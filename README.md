...
graph TD
    ...
    C["Flask Backend (Render)"]
    D["Research Tools (Wikipedia + DuckDuckGo)"]
    E["OpenRouter LLM via LangChain"]
    F["Blog Writer Agent (Heading, Intro, Content, Summary)"]
    G["Blog Saved as Markdown (/outputs)"]
    H["Displayed on Frontend (ChatGPT-like Interface)"]
